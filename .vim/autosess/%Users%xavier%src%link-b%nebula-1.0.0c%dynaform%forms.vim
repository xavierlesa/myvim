...
silent only
cd ~/src/link-b/nebula-1.0.0c/dynaform/forms
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 base.py
badd +0 ~/src/proyectos/paquetes/dynaform/dynaform/forms/base.py
argglobal
silent! argdel *
argadd base.py
set stal=2
...
silent! normal! zE
let s:l = 502 - ((36 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
502
normal! 017|
tabedit ~/src/proyectos/paquetes/dynaform/dynaform/forms/base.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 437 - ((17 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
437
