...
silent only
cd ~/src/proyectos/ciaa/micropython/stmhal
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 led.h
badd +0 ~/src/proyectos/ciaa/micropython/stmhal/led.c
badd +0 ~/src/proyectos/ciaa/micropython/stmhal/make-stmconst.py
argglobal
silent! argdel *
argadd led.h
set stal=2
...
11
normal! 0
tabedit ~/src/proyectos/ciaa/micropython/stmhal/led.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 170 - ((0 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
170
normal! 0
tabedit ~/src/proyectos/ciaa/micropython/stmhal/make-stmconst.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 220 - ((0 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
220
