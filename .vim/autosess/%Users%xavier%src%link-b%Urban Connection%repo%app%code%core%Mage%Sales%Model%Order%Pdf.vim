...
silent only
cd ~/src/link-b/Urban\ Connection/repo/app/code/core/Mage/Sales/Model/Order/Pdf
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 Invoice.php
badd +0 ~/src/link-b/Urban\ Connection/repo/app/code/core/Mage/Sales/Model/Order/Pdf/Abstract.php
argglobal
silent! argdel *
argadd Invoice.php
set stal=2
...
54
normal! 020|
tabedit ~/src/link-b/Urban\ Connection/repo/app/code/core/Mage/Sales/Model/Order/Pdf/Abstract.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 172 - ((0 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
172
