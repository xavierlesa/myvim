...
silent only
cd ~/src/link-b/Town\ Connection/data
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 sync_products.php
badd +0 ~/src/link-b/Town\ Connection/data/create_configprod.php
badd +0 ~/src/link-b/Town\ Connection/data/create_products.php
argglobal
silent! argdel *
...
16
normal! 0
tabedit ~/src/link-b/Town\ Connection/data/create_products.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 235 - ((9 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
235
