...
silent only
cd ~/src/link-b/urbanstore/urbanstore/scripts
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 sync_products.php
badd +0 ~/src/link-b/urbanstore/urbanstore/scripts/create_configprod.php
badd +0 ~/src/link-b/urbanstore/urbanstore/scripts/create_products.php
badd +0 ~/Downloads/WasherDryerAlarm.ino
argglobal
silent! argdel *
argadd sync_products.php
set stal=2
edit sync_products.php
...
silent! normal! zE
let s:l = 277 - ((8 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
277
normal! 0102|
tabedit ~/src/link-b/urbanstore/urbanstore/scripts/create_configprod.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
34
normal! 055|
tabedit ~/src/link-b/urbanstore/urbanstore/scripts/create_products.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 285 - ((7 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
285
normal! 030|
tabedit ~/Downloads/WasherDryerAlarm.ino
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((1 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
