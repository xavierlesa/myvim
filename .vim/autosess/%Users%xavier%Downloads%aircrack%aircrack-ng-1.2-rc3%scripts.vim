...
silent only
cd ~/Downloads/aircrack/aircrack-ng-1.2-rc3/scripts
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 airmon-ng.freebsd
badd +0 ~/Downloads/aircrack/aircrack-ng-1.2-rc3/scripts/airmon-ng
badd +0 ~/Desktop/2016.01.16_11-13-23-GMT-3.wcap
argglobal
silent! argdel *
argadd airmon-ng.freebsd
set stal=2
edit airmon-ng.freebsd
...
49
normal! 0
tabedit ~/Downloads/aircrack/aircrack-ng-1.2-rc3/scripts/airmon-ng
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 84 - ((50 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
