...
silent only
cd ~/src/link-b/Urban\ Connection/repo/app/design/frontend/base/default/template/cms/widget/static_block
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 default.phtml
badd +0 ~/src/link-b/Urban\ Connection/repo/app/code/core/Mage/Cms/Block/Widget/Block.php
badd +0 ~/src/link-b/Urban\ Connection/repo/app/code/core/Mage/Cms/Block/Widget/Page/Link.php
badd +0 ~/src/link-b/Urban\ Connection/repo/app/design/frontend/base/default/template/newsletter/subscribe.phtml
argglobal
silent! argdel *
argadd default.phtml
set stal=2
edit default.phtml
...
1
normal! 05|
tabedit ~/src/link-b/Urban\ Connection/repo/app/code/core/Mage/Cms/Block/Widget/Block.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 33 - ((5 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
normal! 0
tabedit ~/src/link-b/Urban\ Connection/repo/app/design/frontend/base/default/template/newsletter/subscribe.phtml
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
