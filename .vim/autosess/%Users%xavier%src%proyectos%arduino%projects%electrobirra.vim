...
silent only
cd ~/src/proyectos/arduino/projects/electrobirra
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/config.h
badd +0 src/sketch.ino
badd +0 lib/EBXLib/Menu.cpp
badd +0 lib/EBXLib/Menu.h
badd +0 ~/.vimrc
argglobal
silent! argdel *
argadd .
...
silent! normal! zE
let s:l = 54 - ((30 * winheight(0) + 27) / 54)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 38 - ((7 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
normal! 057|
tabedit lib/EBXLib/Menu.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 260 - ((46 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
260
normal! 086|
tabedit lib/EBXLib/Menu.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1362 - ((16 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1362
